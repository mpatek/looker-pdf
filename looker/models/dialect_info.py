...
class DialectInfo(object):
    ...
    def __init__(self, default_max_connections=None, default_port=None, installed=None, label=None, label_for_database_equivalent=None, name=None, supported_options=None, can=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DialectInfo, dict):
