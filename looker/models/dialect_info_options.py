...
class DialectInfoOptions(object):
    ...
    def __init__(self, additional_params=None, auth=None, host=None, oauth_credentials=None, project_name=None, schema=None, ssl=None, timezone=None, tmp_table=None, username_required=None, can=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DialectInfoOptions, dict):
