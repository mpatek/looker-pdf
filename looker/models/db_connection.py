...
class DBConnection(object):
    ...
    def user_db_credentials(self):
        ...
        (Limited access feature) Are per user db credentials enabled. Enabling will remove previously set username and password  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DBConnection, dict):
