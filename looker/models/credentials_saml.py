...
class CredentialsSaml(object):
    ...
    def __init__(self, created_at=None, email=None, is_disabled=None, logged_in_at=None, saml_user_id=None, type=None, url=None, can=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CredentialsSaml, dict):
