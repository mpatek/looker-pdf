...
class DashboardElement(object):
    ...
    def __init__(self, body_text=None, body_text_as_html=None, dashboard_id=None, edit_uri=None, id=None, look=None, look_id=None, merge_result_id=None, note_display=None, note_state=None, note_text=None, note_text_as_html=None, query=None, query_id=None, refresh_interval=None, refresh_interval_to_i=None, result_maker=None, result_maker_id=None, subtitle_text=None, title=None, title_hidden=None, title_text=None, type=None, can=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DashboardElement, dict):
