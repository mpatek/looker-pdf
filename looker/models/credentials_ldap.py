...
class CredentialsLDAP(object):
    ...
    def __init__(self, created_at=None, email=None, is_disabled=None, ldap_dn=None, ldap_id=None, logged_in_at=None, type=None, url=None, can=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CredentialsLDAP, dict):
