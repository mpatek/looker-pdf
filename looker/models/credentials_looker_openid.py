...
class CredentialsLookerOpenid(object):
    ...
    def __init__(self, created_at=None, email=None, is_disabled=None, logged_in_at=None, logged_in_ip=None, type=None, url=None, user_url=None, can=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CredentialsLookerOpenid, dict):
