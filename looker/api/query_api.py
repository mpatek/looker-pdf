...
class QueryApi(object):
    ...
    def create_query_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_query_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def create_query_task(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_query_task(body, async_req=True)
        >>> result = thread.get()
    ...
    def create_query_task_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_query_task_with_http_info(body, async_req=True)
        >>> result = thread.get()
    ...
    def query(self, query_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query(query_id, async_req=True)
        >>> result = thread.get()
    ...
    def query_with_http_info(self, query_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_with_http_info(query_id, async_req=True)
        >>> result = thread.get()
    ...
    def query_for_slug(self, slug, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_for_slug(slug, async_req=True)
        >>> result = thread.get()
    ...
    def query_for_slug_with_http_info(self, slug, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_for_slug_with_http_info(slug, async_req=True)
        >>> result = thread.get()
    ...
    def query_task(self, query_task_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_task(query_task_id, async_req=True)
        >>> result = thread.get()
    ...
    def query_task_with_http_info(self, query_task_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_task_with_http_info(query_task_id, async_req=True)
        >>> result = thread.get()
    ...
    def query_task_multi_results(self, query_task_ids, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_task_multi_results(query_task_ids, async_req=True)
        >>> result = thread.get()
    ...
    def query_task_multi_results_with_http_info(self, query_task_ids, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_task_multi_results_with_http_info(query_task_ids, async_req=True)
        >>> result = thread.get()
    ...
    def query_task_results(self, query_task_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_task_results(query_task_id, async_req=True)
        >>> result = thread.get()
    ...
    def query_task_results_with_http_info(self, query_task_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_task_results_with_http_info(query_task_id, async_req=True)
        >>> result = thread.get()
    ...
    def run_inline_query(self, body, result_format, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_inline_query(body, result_format, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.run_inline_query_with_http_info(body, result_format, **kwargs)  # noqa: E501
        else:
            (data) = self.run_inline_query_with_http_info(body, result_format, **kwargs)  # noqa: E501
            return data

    def run_inline_query_with_http_info(self, body, result_format, **kwargs):  # noqa: E501
        """Run Inline Query  # noqa: E501

        ### Run the query that is specified inline in the posted body.  This allows running a query as defined in json in the posted body. This combines the two actions of posting & running a query into one step.  Here is an example body in json: ``` {   \"model\":\"thelook\",   \"view\":\"inventory_items\",   \"fields\":[\"category.name\",\"inventory_items.days_in_inventory_tier\",\"products.count\"],   \"filters\":{\"category.name\":\"socks\"},   \"sorts\":[\"products.count desc 0\"],   \"limit\":\"500\",   \"query_timezone\":\"America/Los_Angeles\" } ```  When using the Ruby SDK this would be passed as a Ruby hash like: ``` {  :model=>\"thelook\",  :view=>\"inventory_items\",  :fields=>   [\"category.name\",    \"inventory_items.days_in_inventory_tier\",    \"products.count\"],  :filters=>{:\"category.name\"=>\"socks\"},  :sorts=>[\"products.count desc 0\"],  :limit=>\"500\",  :query_timezone=>\"America/Los_Angeles\", } ```  This will return the result of running the query in the format specified by the 'result_format' parameter.  Supported formats:  | result_format | Description | :-----------: | :--- | | json | Plain json | json_detail | Row data plus metadata describing the fields, pivots, table calcs, and other aspects of the query | csv | Comma separated values with a header | txt | Tab separated values with a header | html | Simple html | md | Simple markdown | xlsx | MS Excel spreadsheet | sql | Returns the generated SQL rather than running the query | png | A PNG image of the visualization of the query | jpg | A JPG image of the visualization of the query     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_inline_query_with_http_info(body, result_format, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'result_format', 'limit', 'apply_formatting', 'apply_vis', 'cache', 'image_width', 'image_height', 'generate_drill_links', 'force_production', 'cache_only', 'path_prefix', 'rebuild_pdts', 'server_table_calcs']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def run_query(self, query_id, result_format, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_query(query_id, result_format, async_req=True)
        >>> result = thread.get()
    ...
    def run_query_with_http_info(self, query_id, result_format, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_query_with_http_info(query_id, result_format, async_req=True)
        >>> result = thread.get()
    ...
    def run_url_encoded_query(self, model_name, view_name, result_format, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_url_encoded_query(model_name, view_name, result_format, async_req=True)
        >>> result = thread.get()
    ...
    def run_url_encoded_query_with_http_info(self, model_name, view_name, result_format, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.run_url_encoded_query_with_http_info(model_name, view_name, result_format, async_req=True)
        >>> result = thread.get()
