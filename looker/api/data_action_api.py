...
class DataActionApi(object):
    ...
    def fetch_remote_data_action_form(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.fetch_remote_data_action_form(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param dict(str, str) body: Data Action Request (required)
    ...
    def fetch_remote_data_action_form_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.fetch_remote_data_action_form_with_http_info(body, async_req=True)
        >>> result = thread.get()
    ...
    def perform_data_action(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.perform_data_action(body, async_req=True)
        >>> result = thread.get()
    ...
    def perform_data_action_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.perform_data_action_with_http_info(body, async_req=True)
        >>> result = thread.get()
