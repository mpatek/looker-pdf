...
class RunningQueriesApi(object):
    ...
    def all_running_queries(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.all_running_queries(async_req=True)
        >>> result = thread.get()
    ...
    def all_running_queries_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.all_running_queries_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def kill_query(self, query_task_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.kill_query(query_task_id, async_req=True)
        >>> result = thread.get()
    ...
    def kill_query_with_http_info(self, query_task_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.kill_query_with_http_info(query_task_id, async_req=True)
        >>> result = thread.get()
